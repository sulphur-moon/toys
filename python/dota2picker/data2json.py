...
def main():
	...
	for row in res:
		...
		dict_hero[row[1]]['pic_url'] = row[3][46:]
	json_str = json.dumps(dict_hero, ensure_ascii=False)
	print(json_str)
	...
	json_str = json.dumps(dict_anti, ensure_ascii=False)
	#print(json_str)
	...
	#json_str = json.dumps(dict_anti, indent=4, ensure_ascii=False)
	json_str = json.dumps(dict_comb, ensure_ascii=False)
	#print(json_str)
